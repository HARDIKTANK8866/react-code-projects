        ...
        <Container>
          <div className="flex flex-wrap justify-center">
            <div class="sm:w-2/5 flex flex-col items-center sm:items-start text-center sm:text-left">
              <h1 class="uppercase text-6xl text-blue-900 font-bold leading-none tracking-wide mb-2">
                Blog
              </h1>
              <h2 class="uppercase text-4xl text-orange-500 text-secondary tracking-widest mb-6">
                LATEST STORIES
              </h2>
              <p class="text-gray-600 leading-relaxed mb-12">
                The way we think and feel impacts everything we do. If we can
                manage our thoughts and perspectives, we can adjust our emotions
                to live life better. Therefore, happiness is just a thought
                away, a choice away. I love to share topics on personal
                development, character building, meditation commentaries,
                quotes, poetry, positivity and more. As a blogger, I do also
                share blogging tips.
              </p>
              <a
                href="#"
